...
% set the format of date for \today 
...
% \renewcommand{\aiZenodo}{\raisebox{0.2ex}{\scalebox{1.3}{\aiZenodo}}}
...
\cvtag{Sound Zone Control}
% \cvtag{Computational Acoustics}
% \\
% \cvtag{Non-Hermitian Physics}
% \cvtag{Topological Physics}

\cvsection{Employment \hfill \faBuilding}

\cvevent{\faUserTie Post-Doc}{\faUniversity Penn State University}{Dec-2022 -- Present}{University Park, USA}
...
\begin{itemize}
    \item \hrefhl{https://link.springer.com/journal/40857}{Acoustics Australia} \hfill \faCalendar* 2023 -- Present
    ...
    \item \hrefhl{https://journals.aps.org/prl/}{Physical Review Letter} \hfill \faCalendar* 2024 -- Present
