...
\begin{document}
\name{{Jiaxin ZHONG (钟家鑫)}}
\tagline{Post-Doc in Acoustics at Penn State University (PSU)}
...
\cvevent{\faUserTie Post-Doc}{\faUniversity Penn State University}{Dec-2022 -- Ongoing}{University Park, USA}
\faUserTie Advisor: Dr.\ Yun Jing \href{https://scholar.google.com/citations?hl=en&user=nkb3d8UAAAAJ}{\color{accent}\aiGoogleScholarSquare}\href{https://orcid.org/0000-0003-2960-5292}{\color{accent}\faOrcid}\hspace{-0.1cm}\href{https://www.linkedin.com/in/yun-jing-15605b15/}{\color{accent}\faLinkedin}\hspace{-0.1cm}\href{https://sites.psu.edu/jinglab/members/}{\color{accent}\faGlobe}
...
\faUserTie Advisors: Prof.\ Ray Kirby \href{https://scholar.google.com.au/citations?user=wNTEciAAAAAJ&hl=en}{\color{accent}\aiGoogleScholarSquare}\href{https://orcid.org/0000-0002-3520-1377}{\color{accent}\faOrcid}\hspace{-0.1cm}\href{https://www.linkedin.com/in/ray-kirby-423148262/}{\color{accent}\faLinkedin}, 
Dr.\ Mahmoud Karimi \href{https://scholar.google.com/citations?user=uIwfBR8AAAAJ&hl=en}{\color{accent}\aiGoogleScholarSquare}\href{https://orcid.org/0000-0002-2949-5364}{\color{accent}\faOrcid}\hspace{-0.1cm}\href{https://www.linkedin.com/in/mahmoud-karimi-913b093a/}{\color{accent}\faLinkedin}, 
...
{\color{accent}ASA Early Career Travel Support Award}  % $500
\hfill \faCalendar* 17-Apr-2023
\par
...
\begin{itemize}[leftmargin = 25pt]
    ...
    \textit{Chemical Rubber Company (CRC) Press}, In press (2023).
\end{itemize}
...
\begin{itemize}[leftmargin = 30pt]
    ...
    \item[{[J24]}]
        \underline{Tao Zhuang}, \PubCorAuthor{\PubMe{Jiaxin Zhong}}, Guilin Ma, Feng Niu, and Jing Lu,
        \PubTitle{Modeling a phased array of parametric array loudspeaker using the spherical wave expansion}
        Under review (2023).
...
\begin{itemize}[leftmargin = 30pt]
    \item [{[C12]}]
        \ul{Tao Zhuang}, \PubCorAuthor{\PubMe{Jiaxin Zhong}}, Jing Lu, Feng Niu, and Longbiao He,
        \PubTitle{Performance of a steerable focusing parametric array loudspeaker}
        \PubConference{2024 IEEE International Conference on Acoustics, Speech and Signal Processing},
        Coex, Seoul, Korea, Apr 14--19, 2024.
    \item [{[C11]}]
        \ul{Mengtong Li}, \PubCorAuthor{\PubMe{Jiaxin Zhong}}, Haishan Zou, and Jing Lu,
        \PubTitle{System identification of a parametric array loudspeaker using variational recurrent neural network}
        \PubConference{2024 IEEE International Conference on Acoustics, Speech and Signal Processing},
        Coex, Seoul, Korea, Apr 14--19, 2024.
    \item [{[C10]}]
...
\cvsubsection{\printinfo{\faAward}{Issued Patents}}
...
\begin{itemize}[leftmargin = 25pt]
    \item[{[P1]}] \PubMe{Jiaxin Zhong}, Jiancheng Tao, and Xiaojun Qiu,
        ...
        \href{http://www.soopat.com/Patent/201811394850}{\color{accent}\faGlobe}
\end{itemize}
...
\begin{itemize}
    ...
    \item \hrefhl{https://www.amazon.com/Vibration-Engineering-Sustainable-Future-Passive/dp/3030476170}{The 18th Asia-Pacific Vibration Coference (APVC)} \hfill \faCalendar* 2019 
...
\cvsubsection{\printinfo{\faChalkboardTeacher}{Session Chair}}
\begin{itemize}
    \item 
    ...
    \hfill \faMapMarker Sydney, Australia  \faCalendar* 4--8 Dec 2023
\end{itemize}
